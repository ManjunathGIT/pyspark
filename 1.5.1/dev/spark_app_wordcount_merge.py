...
hadoopConf = {"mapreduce.input.fileinputformat.inputdir": "/user/hdfs/rawlog/app_weibomobilekafka1234_topweiboimpression/2016_02_21/00/",
...
lines = source.coalesce(15).map(lambda pair: pair[1])
